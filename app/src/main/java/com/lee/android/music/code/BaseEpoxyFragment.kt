...
abstract class BaseEpoxyFragment : BaseMvRxFragment() {
  ...
  protected lateinit var topBarLayout: QMUITopBarLayout
  ...
  override fun onCreateView(
    ...
    return inflater.inflate(R.layout.fragment_base_epoxy_mvrx, container, false)
        .apply {
          ...
          topBarLayout.addLeftBackImageButton()
